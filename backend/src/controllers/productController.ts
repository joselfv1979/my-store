...
import { getFilteredProducts, getProduct, addProduct, deleteProduct, updateProduct } from '../services/productService';
import { getRating } from '../utils/productRating';

export const getProductList = async (req: Request<{},{},{},ProductFilters>, res: Response, next: NextFunction) => {
